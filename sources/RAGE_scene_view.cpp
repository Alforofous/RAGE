...
RAGE_scene_view::RAGE_scene_view(Widget *parent) : nanogui::GLCanvas(parent), mRotation(nanogui::Vector3f(0.25f, 0.5f, 0.33f))
{
	base_shader = new GLShader();
	base_shader->init(
		/* An identifying name */
		"a_simple_shader",
	...
	base_shader->bind();
	base_shader->uploadIndices(indices);
